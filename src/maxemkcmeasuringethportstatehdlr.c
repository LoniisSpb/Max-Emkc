...
/**************************************************************************
 *  File		: maxemkcmeasuringethportstatehdlr.c.
 *
 *  Purpose		: To handle the requests from the manager for the 
 * 				  module maxemkcmeasuringethportstate.
 *
 *  Author		: WebNMS Agent Toolkit C Edition 6
 *
 *  Date		: Fri Jan 26 16:40:25 MSK 2018
 *
 *  See Also	: maxemkcmeasuringethportstateftov.c,
 *				  maxemkcmeasuringethportstateinstru.c,
 *				  maxemkcmeasuringethportstate.h,
 *				  maxemkctraps.c.
 *
 *  Docs		: Yes. 
 ***************************************************************************/
...
#define MAXEMKCMEASURINGETHPORTSTATE_PUBLIC
#include "maxemkcmeasuringethportstate.h" 

/* This tree cell is used to register with agent.*/
TreeCell gv_maxEmkcMeasuringEthPortStateCell1 =
	{
		"MAX-EMKC:MaxEmkcMeasuringEthPortStateGroup1",
		SNMP_VERSION_2c, gv_maxEmkcMeasuringEthPortStateGroup1Oid,
		MAXEMKCMEASURINGETHPORTSTATE_OID_LEN, NOT_TABLE,
		gv_maxEmkcMeasuringEthPortStateGroup1SubIdList,
		MAXEMKCMEASURINGETHPORTSTATE_GROUP1_SUBID_LEN,
		gv_maxEmkcMeasuringEthPortStateGroup1SubIdListAccess,
		gv_maxEmkcMeasuringEthPortStateGroup1SubIdListDataTypes,
		0,MaxEmkcMeasuringEthPortStateProcessRequests,
		MaxEmkcMeasuringEthPortStateProcessReadReq,
		MaxEmkcMeasuringEthPortStateProcessWriteReq,
		UpdateMaxEmkcMeasuringEthPortState,
		NULL, NULL
	};

/*****************************************************************************
 *	Function Name	: InitMaxEmkcMeasuringEthPortState()
 *
 *	Args			: Nothing.
 *
 *	Returns			: Nothing.
 ...
 * 					  "maxEmkcMeasuringEthPortState".
 *
 *	Docs			: Yes.
 *
 *	Bugs			: 
 *****************************************************************************/
void InitMaxEmkcMeasuringEthPortState(void)
{
	CHAR ftovFlag;

	DEBUGMSG1("\n\t@@@@@ Inside InitMaxEmkcMeasuringEthPortState() @@@@@\n");

	ftovFlag = FAILURE;

	/* Register the oid as a listener to the agent. */
	if (RegisterOID(&gv_maxEmkcMeasuringEthPortStateCell1) == FAILURE)
	{
		DEBUGMSG1("Unable to register for the modulemaxEmkcMeasuringEthPortState\n");
		return;
	}

#ifdef FILE_TO_VECTOR
	/* Read all the values of "maxEmkcMeasuringEthPortState" from the file */
	ftovFlag = ReadFromMaxEmkcMeasuringEthPortStateFile();
#endif

	if(ftovFlag == FAILURE)
	{

		/* Assigning the default value for scalar object "gv_maxEmkcMeasEthPortLinkStatus" */
		gv_maxEmkcMeasEthPortLinkStatus = 1;

#ifdef FILE_TO_VECTOR
	/* Write the values of "maxEmkcMeasuringEthPortState" into the file */
	WriteToMaxEmkcMeasuringEthPortStateFile();
#endif
	}
...
/*****************************************************************************
 *	Function Name	: MaxEmkcMeasuringEthPortStateProcessRequests()
 *
 ...
 *****************************************************************************/
CHAR MaxEmkcMeasuringEthPortStateProcessRequests(INT32 pduVersion, U_CHAR pduType, Vector *varBinds, LONG *errStatus, LONG *errIndex)
{
	/*
	...
	DEBUGMSG1("\n\t@@@@@ Inside MaxEmkcMeasuringEthPortStateProcessRequests() @@@@@\n");
...
/*****************************************************************************
 *	Function Name	: MaxEmkcMeasuringEthPortStateProcessReadReq()
 *
 ...
 *	Bugs			: 
 *****************************************************************************/
U_CHAR *MaxEmkcMeasuringEthPortStateProcessReadReq(U_CHAR pduType, OID *reqOid, INT32 *reqOidLen, INT32 *varValLen, U_CHAR *status)
{
	...
	DEBUGMSG1("\n\t@@@@@ Inside MaxEmkcMeasuringEthPortStateProcessReadReq() @@@@@\n");

	retPtr = NULL;
	column = reqOid[MAXEMKCMEASURINGETHPORTSTATE_OID_LEN-1];
	...
	*status = SNMP_ERR_NOERROR;
	...
	switch(column)
	{
		case	MAXEMKCMEASURINGETHPORTSTATE_MAXEMKCMEASETHPORTLINKSTATUS:
				retPtr = GetMaxEmkcMeasEthPortLinkStatus( varValLen, status);
				break;
...
/*****************************************************************************
 *	Function Name	: MaxEmkcMeasuringEthPortStateProcessWriteReq()
 *
 ...
 *	Bugs			: 
 *****************************************************************************/
U_CHAR *MaxEmkcMeasuringEthPortStateProcessWriteReq(INT32 pduVersion, OID *reqOid, INT32 reqOidLen, U_CHAR *varVal, INT32 *varValLen, U_CHAR *status)
{
	...
	DEBUGMSG1("\n\t@@@@@ Inside MaxEmkcMeasuringEthPortStateProcessWriteReq() @@@@@\n");
...
/*****************************************************************************
 *	Function Name	: UpdateMaxEmkcMeasuringEthPortState()
 *
 *	Args			: command type.
 *
 *	Returns			: SUCCESS or FAILURE.
 ...
 *					  structrue with the changes made to MaxEmkcMeasuringEthPortState.
 ...
 *	Bugs			: 
 *****************************************************************************/
CHAR UpdateMaxEmkcMeasuringEthPortState(U_CHAR command)
{
	CHAR retVal;

	DEBUGMSG1("\n\t@@@@@ Inside UpdateMaxEmkcMeasuringEthPortState() @@@@@\n");
...
/*****************************************************************************
 *						 End of maxemkcmeasuringethportstatehdlr.c
 *****************************************************************************/
