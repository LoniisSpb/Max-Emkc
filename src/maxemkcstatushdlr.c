 ...
 *
 *  See Also	: maxemkcstatusftov.c,
 *				  maxemkcstatusinstru.c,
 *				  maxemkcstatus.h,
 *				  maxemkctraps.c.
 *
 *  Docs		: Yes. 
...
#define MAXEMKCSTATUS_PUBLIC
#include "maxemkcstatus.h" 

/* This tree cell is used to register with agent.*/
TreeCell gv_maxEmkcStatusCell1 =
	{
		"MAX-EMKC:MaxEmkcStatusGroup1",
		SNMP_VERSION_2c, gv_maxEmkcStatusGroup1Oid,
		MAXEMKCSTATUS_OID_LEN, NOT_TABLE,
		gv_maxEmkcStatusGroup1SubIdList,
		MAXEMKCSTATUS_GROUP1_SUBID_LEN,
		gv_maxEmkcStatusGroup1SubIdListAccess,
		gv_maxEmkcStatusGroup1SubIdListDataTypes,
		0,MaxEmkcStatusProcessRequests,
		MaxEmkcStatusProcessReadReq,
		MaxEmkcStatusProcessWriteReq,
		UpdateMaxEmkcStatus,
		NULL, NULL
	};

TreeCell gv_maxEmkcStatusCell2 =
	{
		"MAX-EMKC:MaxEmkcStatusGroup2",
		SNMP_VERSION_2c, gv_maxEmkcStatusGroup2Oid,
		MAXEMKCSTATUS_OID_LEN, NOT_TABLE,
		gv_maxEmkcStatusGroup2SubIdList,
		MAXEMKCSTATUS_GROUP2_SUBID_LEN,
		gv_maxEmkcStatusGroup2SubIdListAccess,
		gv_maxEmkcStatusGroup2SubIdListDataTypes,
		0,MaxEmkcStatusProcessRequests,
		MaxEmkcStatusProcessReadReq,
		MaxEmkcStatusProcessWriteReq,
		UpdateMaxEmkcStatus,
...
/*****************************************************************************
 *	Function Name	: InitMaxEmkcStatus()
 *
 *	Args			: Nothing.
 *
 *	Returns			: Nothing.
 ...
 *	Bugs			: 
 *****************************************************************************/
void InitMaxEmkcStatus(void)
{
	CHAR ftovFlag;

	DEBUGMSG1("\n\t@@@@@ Inside InitMaxEmkcStatus() @@@@@\n");

	ftovFlag = FAILURE;

	/* Register the oid as a listener to the agent. */
	if (RegisterOID(&gv_maxEmkcStatusCell1) == FAILURE)
	{
		DEBUGMSG1("Unable to register for the modulemaxEmkcStatus\n");
		return;
	}

	/* Register the oid as a listener to the agent. */
	if (RegisterOID(&gv_maxEmkcStatusCell2) == FAILURE)
	{
		DEBUGMSG1("Unable to register for the modulemaxEmkcStatus\n");
		return;
	}
	...
	/* Read all the values of "maxEmkcStatus" from the file */
	ftovFlag = ReadFromMaxEmkcStatusFile();
#endif

	if(ftovFlag == FAILURE)
	{

		/* Assigning the default value for scalar object "gv_maxEmkcMeasuringModuleState" */
		gv_maxEmkcMeasuringModuleState = 1;

		/* Assigning the default value for scalar object "gv_maxEmkcCfgFirmwareUpdatingStatus" */
		gv_maxEmkcCfgFirmwareUpdatingStatus = 1;

#ifdef FILE_TO_VECTOR
	/* Write the values of "maxEmkcStatus" into the file */
	WriteToMaxEmkcStatusFile();
#endif
	}
...
/*****************************************************************************
 *	Function Name	: MaxEmkcStatusProcessRequests()
 *
 ...
 *****************************************************************************/
CHAR MaxEmkcStatusProcessRequests(INT32 pduVersion, U_CHAR pduType, Vector *varBinds, LONG *errStatus, LONG *errIndex)
{
	/*
	...
	DEBUGMSG1("\n\t@@@@@ Inside MaxEmkcStatusProcessRequests() @@@@@\n");
...
/*****************************************************************************
 *	Function Name	: MaxEmkcStatusProcessReadReq()
 *
 ...
 *	Bugs			: 
 *****************************************************************************/
U_CHAR *MaxEmkcStatusProcessReadReq(U_CHAR pduType, OID *reqOid, INT32 *reqOidLen, INT32 *varValLen, U_CHAR *status)
{
	...
	DEBUGMSG1("\n\t@@@@@ Inside MaxEmkcStatusProcessReadReq() @@@@@\n");

	retPtr = NULL;
	column = reqOid[MAXEMKCSTATUS_OID_LEN-1];
	...
	*status = SNMP_ERR_NOERROR;
	...
	switch(column)
	{
		case	MAXEMKCSTATUS_MAXEMKCMEASURINGMODULESTATE:
				retPtr = GetMaxEmkcMeasuringModuleState( varValLen, status);
				break;

		case	MAXEMKCSTATUS_MAXEMKCCFGFIRMWAREUPDATINGSTATUS:
				retPtr = GetMaxEmkcCfgFirmwareUpdatingStatus( varValLen, status);
				break;
...
/*****************************************************************************
 *	Function Name	: MaxEmkcStatusProcessWriteReq()
 *
 ...
 *	Bugs			: 
 *****************************************************************************/
U_CHAR *MaxEmkcStatusProcessWriteReq(INT32 pduVersion, OID *reqOid, INT32 reqOidLen, U_CHAR *varVal, INT32 *varValLen, U_CHAR *status)
{
	...
	DEBUGMSG1("\n\t@@@@@ Inside MaxEmkcStatusProcessWriteReq() @@@@@\n");
...
/*****************************************************************************
 *	Function Name	: UpdateMaxEmkcStatus()
 *
 *	Args			: command type.
 *
 *	Returns			: SUCCESS or FAILURE.
 ...
 *					  structrue with the changes made to MaxEmkcStatus.
 ...
 *	Bugs			: 
 *****************************************************************************/
CHAR UpdateMaxEmkcStatus(U_CHAR command)
{
	CHAR retVal;

	DEBUGMSG1("\n\t@@@@@ Inside UpdateMaxEmkcStatus() @@@@@\n");
