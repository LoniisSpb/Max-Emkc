...
/**************************************************************************
 *  File		: maxemkccfgtraffictesthdlr.c.
 *
 *  Purpose		: To handle the requests from the manager for the 
 * 				  module maxemkccfgtraffictest.
 *
 *  Author		: WebNMS Agent Toolkit C Edition 6
 *
 *  Date		: Fri Jan 26 16:40:41 MSK 2018
 *
 *  See Also	: maxemkccfgtraffictestftov.c,
 *				  maxemkccfgtraffictestinstru.c,
 *				  maxemkccfgtraffictest.h,
 *				  maxemkctraps.c.
 *
 *  Docs		: Yes. 
 ***************************************************************************/
...
#define MAXEMKCCFGTRAFFICTEST_PUBLIC
#include "maxemkccfgtraffictest.h" 

/* This tree cell is used to register with agent.*/
TreeCell gv_maxEmkcCfgTrafficTestCell1 =
	{
		"MAX-EMKC:MaxEmkcCfgTrafficTestGroup1",
		SNMP_VERSION_2c, gv_maxEmkcCfgTrafficTestGroup1Oid,
		MAXEMKCCFGTRAFFICTEST_OID_LEN, NOT_TABLE,
		gv_maxEmkcCfgTrafficTestGroup1SubIdList,
		MAXEMKCCFGTRAFFICTEST_GROUP1_SUBID_LEN,
		gv_maxEmkcCfgTrafficTestGroup1SubIdListAccess,
		gv_maxEmkcCfgTrafficTestGroup1SubIdListDataTypes,
		0,MaxEmkcCfgTrafficTestProcessRequests,
		MaxEmkcCfgTrafficTestProcessReadReq,
		MaxEmkcCfgTrafficTestProcessWriteReq,
		UpdateMaxEmkcCfgTrafficTest,
		NULL, NULL
	};

/*****************************************************************************
 *	Function Name	: InitMaxEmkcCfgTrafficTest()
 *
 *	Args			: Nothing.
 *
 *	Returns			: Nothing.
 ...
 * 					  "maxEmkcCfgTrafficTest".
 *
 *	Docs			: Yes.
 *
 *	Bugs			: 
 *****************************************************************************/
void InitMaxEmkcCfgTrafficTest(void)
{
	CHAR ftovFlag;

	DEBUGMSG1("\n\t@@@@@ Inside InitMaxEmkcCfgTrafficTest() @@@@@\n");

	ftovFlag = FAILURE;

	/* Register the oid as a listener to the agent. */
	if (RegisterOID(&gv_maxEmkcCfgTrafficTestCell1) == FAILURE)
	{
		DEBUGMSG1("Unable to register for the modulemaxEmkcCfgTrafficTest\n");
		return;
	}

#ifdef FILE_TO_VECTOR
	/* Read all the values of "maxEmkcCfgTrafficTest" from the file */
	ftovFlag = ReadFromMaxEmkcCfgTrafficTestFile();
#endif

	if(ftovFlag == FAILURE)
	{

		/* Assigning the default value for scalar object "gv_maxEmkcCfgTrafficTestEntryRowChoice" */
		gv_maxEmkcCfgTrafficTestEntryRowChoice = 1;

#ifdef FILE_TO_VECTOR
	/* Write the values of "maxEmkcCfgTrafficTest" into the file */
	WriteToMaxEmkcCfgTrafficTestFile();
#endif
	}
...
/*****************************************************************************
 *	Function Name	: MaxEmkcCfgTrafficTestProcessRequests()
 *
 ...
 *****************************************************************************/
CHAR MaxEmkcCfgTrafficTestProcessRequests(INT32 pduVersion, U_CHAR pduType, Vector *varBinds, LONG *errStatus, LONG *errIndex)
{
	/*
	...
	DEBUGMSG1("\n\t@@@@@ Inside MaxEmkcCfgTrafficTestProcessRequests() @@@@@\n");
...
/*****************************************************************************
 *	Function Name	: MaxEmkcCfgTrafficTestProcessReadReq()
 *
 ...
 *	Bugs			: 
 *****************************************************************************/
U_CHAR *MaxEmkcCfgTrafficTestProcessReadReq(U_CHAR pduType, OID *reqOid, INT32 *reqOidLen, INT32 *varValLen, U_CHAR *status)
{
	...
	DEBUGMSG1("\n\t@@@@@ Inside MaxEmkcCfgTrafficTestProcessReadReq() @@@@@\n");

	retPtr = NULL;
	column = reqOid[MAXEMKCCFGTRAFFICTEST_OID_LEN-1];
	...
	*status = SNMP_ERR_NOERROR;
	...
	switch(column)
	{
		case	MAXEMKCCFGTRAFFICTEST_MAXEMKCCFGTRAFFICTESTENTRYROWCHOICE:
				retPtr = GetMaxEmkcCfgTrafficTestEntryRowChoice( varValLen, status);
				break;
...
/*****************************************************************************
 *	Function Name	: MaxEmkcCfgTrafficTestProcessWriteReq()
 *
 ...
 *	Bugs			: 
 *****************************************************************************/
U_CHAR *MaxEmkcCfgTrafficTestProcessWriteReq(INT32 pduVersion, OID *reqOid, INT32 reqOidLen, U_CHAR *varVal, INT32 *varValLen, U_CHAR *status)
{
	...
	DEBUGMSG1("\n\t@@@@@ Inside MaxEmkcCfgTrafficTestProcessWriteReq() @@@@@\n");
	...
	{
		case	MAXEMKCCFGTRAFFICTEST_MAXEMKCCFGTRAFFICTESTENTRYROWCHOICE:
				retPtr = SetMaxEmkcCfgTrafficTestEntryRowChoice( varVal, varValLen, status);
				break;
...
/*****************************************************************************
 *	Function Name	: UpdateMaxEmkcCfgTrafficTest()
 *
 *	Args			: command type.
 *
 *	Returns			: SUCCESS or FAILURE.
 ...
 *					  structrue with the changes made to MaxEmkcCfgTrafficTest.
 ...
 *	Bugs			: 
 *****************************************************************************/
CHAR UpdateMaxEmkcCfgTrafficTest(U_CHAR command)
{
	CHAR retVal;

	DEBUGMSG1("\n\t@@@@@ Inside UpdateMaxEmkcCfgTrafficTest() @@@@@\n");
...
/*****************************************************************************
 *						 End of maxemkccfgtraffictesthdlr.c
 *****************************************************************************/
