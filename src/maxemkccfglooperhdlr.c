...
/**************************************************************************
 *  File		: maxemkccfglooperhdlr.c.
 *
 *  Purpose		: To handle the requests from the manager for the 
 * 				  module maxemkccfglooper.
 *
 *  Author		: WebNMS Agent Toolkit C Edition 6
 *
 *  Date		: Fri Jan 26 16:40:44 MSK 2018
 *
 *  See Also	: maxemkccfglooperftov.c,
 *				  maxemkccfglooperinstru.c,
 *				  maxemkccfglooper.h,
 *				  maxemkctraps.c.
 *
 *  Docs		: Yes. 
...
#define MAXEMKCCFGLOOPER_PUBLIC
#include "maxemkccfglooper.h" 

/* This tree cell is used to register with agent.*/
TreeCell gv_maxEmkcCfgLooperCell1 =
	{
		"MAX-EMKC:MaxEmkcCfgLooperGroup1",
		SNMP_VERSION_2c, gv_maxEmkcCfgLooperGroup1Oid,
		MAXEMKCCFGLOOPER_OID_LEN, NOT_TABLE,
		gv_maxEmkcCfgLooperGroup1SubIdList,
		MAXEMKCCFGLOOPER_GROUP1_SUBID_LEN,
		gv_maxEmkcCfgLooperGroup1SubIdListAccess,
		gv_maxEmkcCfgLooperGroup1SubIdListDataTypes,
		0,MaxEmkcCfgLooperProcessRequests,
		MaxEmkcCfgLooperProcessReadReq,
		MaxEmkcCfgLooperProcessWriteReq,
		UpdateMaxEmkcCfgLooper,
		NULL, NULL
	};

/*****************************************************************************
 *	Function Name	: InitMaxEmkcCfgLooper()
 *
 *	Args			: Nothing.
 *
 *	Returns			: Nothing.
 ...
 *	Bugs			: 
 *****************************************************************************/
void InitMaxEmkcCfgLooper(void)
{
	CHAR ftovFlag;

	DEBUGMSG1("\n\t@@@@@ Inside InitMaxEmkcCfgLooper() @@@@@\n");

	ftovFlag = FAILURE;

	/* Register the oid as a listener to the agent. */
	if (RegisterOID(&gv_maxEmkcCfgLooperCell1) == FAILURE)
	{
		DEBUGMSG1("Unable to register for the modulemaxEmkcCfgLooper\n");
		return;
	}

#ifdef FILE_TO_VECTOR
	/* Read all the values of "maxEmkcCfgLooper" from the file */
	ftovFlag = ReadFromMaxEmkcCfgLooperFile();
#endif

	if(ftovFlag == FAILURE)
	{

		/* Assigning the default value for scalar object "gv_maxEmkcCfgLooperEntryRowChoice" */
		gv_maxEmkcCfgLooperEntryRowChoice = 1;

#ifdef FILE_TO_VECTOR
	/* Write the values of "maxEmkcCfgLooper" into the file */
	WriteToMaxEmkcCfgLooperFile();
#endif
	}
...
/*****************************************************************************
 *	Function Name	: MaxEmkcCfgLooperProcessRequests()
 *
 ...
 *****************************************************************************/
CHAR MaxEmkcCfgLooperProcessRequests(INT32 pduVersion, U_CHAR pduType, Vector *varBinds, LONG *errStatus, LONG *errIndex)
{
	/*
	...
	DEBUGMSG1("\n\t@@@@@ Inside MaxEmkcCfgLooperProcessRequests() @@@@@\n");
...
/*****************************************************************************
 *	Function Name	: MaxEmkcCfgLooperProcessReadReq()
 *
 ...
 *	Bugs			: 
 *****************************************************************************/
U_CHAR *MaxEmkcCfgLooperProcessReadReq(U_CHAR pduType, OID *reqOid, INT32 *reqOidLen, INT32 *varValLen, U_CHAR *status)
{
	...
	DEBUGMSG1("\n\t@@@@@ Inside MaxEmkcCfgLooperProcessReadReq() @@@@@\n");

	retPtr = NULL;
	column = reqOid[MAXEMKCCFGLOOPER_OID_LEN-1];
	...
	*status = SNMP_ERR_NOERROR;
	...
	switch(column)
	{
		case	MAXEMKCCFGLOOPER_MAXEMKCCFGLOOPERENTRYROWCHOICE:
				retPtr = GetMaxEmkcCfgLooperEntryRowChoice( varValLen, status);
				break;
...
/*****************************************************************************
 *	Function Name	: MaxEmkcCfgLooperProcessWriteReq()
 *
 ...
 *	Bugs			: 
 *****************************************************************************/
U_CHAR *MaxEmkcCfgLooperProcessWriteReq(INT32 pduVersion, OID *reqOid, INT32 reqOidLen, U_CHAR *varVal, INT32 *varValLen, U_CHAR *status)
{
	...
	DEBUGMSG1("\n\t@@@@@ Inside MaxEmkcCfgLooperProcessWriteReq() @@@@@\n");
	...
	{
		case	MAXEMKCCFGLOOPER_MAXEMKCCFGLOOPERENTRYROWCHOICE:
				retPtr = SetMaxEmkcCfgLooperEntryRowChoice( varVal, varValLen, status);
				break;
...
/*****************************************************************************
 *	Function Name	: UpdateMaxEmkcCfgLooper()
 *
 *	Args			: command type.
 *
 *	Returns			: SUCCESS or FAILURE.
 ...
 *					  structrue with the changes made to MaxEmkcCfgLooper.
 ...
 *	Bugs			: 
 *****************************************************************************/
CHAR UpdateMaxEmkcCfgLooper(U_CHAR command)
{
	CHAR retVal;

	DEBUGMSG1("\n\t@@@@@ Inside UpdateMaxEmkcCfgLooper() @@@@@\n");
